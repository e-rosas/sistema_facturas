                ...
                <div class="card card-stats ">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                @else
                                    ...
                                    <br />
                                    <span
                                        class="h4 font-weight-400 mb-2">{{ $patient->insuree->insurance()->insurer->email }}</span>
                                @endif
                        ...
                        @if ($patient->insured)
                            <div class="row">
                                <div class="col"><span
                                        class="h3 font-weight-bold mb-0">{{ $patient->insuree->nss }}</span>
                                </div>
                                <div class="col"><span
            ...
            <div class="col-xl-3 order-xl-2 mb-5 mb-xl-0">
                <div class="card card-profile shadow">
                    <div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
                        ...
                        <div class="m-2">
                            <form method="post"
                                onsubmit="return confirm('Confirmar eliminación del paciente. TODOS LOS COBROS, PAGOS, LLAMADAS, DOCUMENTOS, Y CARTAS SERÁN ELIMINADOS. SI EL PACIENTE TIENE DEPENDIENTES ESTOS TAMBIÉN SERÁN ELIMINADOS.');"
                        ...
                        <form method="post" action="{{ route('patient.letter.send', $patient) }}">
                            @csrf
                            <div class="form-row">
                                {{-- start_date --}}
                            ...
                            <div class="form-group">
                                <label for="campaign_id" class="col-auto col-form-label">Campaña</label>
                                <select id="campaign_id" class="custom-select form-control" name="campaign_id">
                            ...
                            <div class="form-row pt-md-2">
                                ...
                                <div class="col-lg-6">
                                    <div class="custom-control custom-control-alternative custom-checkbox mb-3">
                                        <input {{ count($campaigns) < 1 ? 'disabled' : '' }} type="checkbox" name="mail"
                                            id="input-mail" class="custom-control-input">
