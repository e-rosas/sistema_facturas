                    ...
                    <form method="post" action="{{ route('patients.update', $patient) }}" autocomplete="off">
                        ...
                        <div class="pl-lg-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 form-group{{ $errors->has('last_name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="last_name" id="update-last_name"
                            ...
                            <div class="row">
                                <div
                                    class="form-group{{ $errors->has('birth_date') ? ' has-danger' : '' }} col-md-4 col-auto">
                                    <label class="form-control-label" for="update-birth_date">Fecha de
                                        nacimiento</label>
                                    <div class="update-group update-group-alternative">
                                        <div class="update-group-prepend">
                                            <span class="update-group-text"><i
                                ...
                                <div
                                    class="form-group{{ $errors->has('street_number') ? ' has-danger' : '' }} col-md-2 col-auto">
                                    <label class="form-control-label" for="update-street_number">Num.de Calle</label>
                                    <input type="text" name="street_number" id="update-street_number"
                                        class="form-control form-control-alternative{{ $errors->has('street_number') ? ' is-invalid' : '' }}"
                                ...
                                <div
                                    class="form-group{{ $errors->has('street') ? ' has-danger' : '' }} col-md-6 col-auto">
                            ...
                            <div class="row">
                                <div
                                    class="form-group{{ $errors->has('city') ? ' has-danger' : '' }} col-md-4 col-auto">
                                ...
                                <div
                                    class="form-group{{ $errors->has('state') ? ' has-danger' : '' }} col-md-4 col-auto">
                                ...
                                <div
                                    class="form-group{{ $errors->has('zip_code') ? ' has-danger' : '' }} col-md-4 col-auto">
                                    <label class="form-control-label" for="update-zip_code">Código Postal</label>
                                    <input type="text" name="zip_code" id="update-zip_code"
                                        class="form-control form-control-alternative{{ $errors->has('zip_code') ? ' is-invalid' : '' }}"
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <select id='update-gender' class="custom-select" name="gender">
                                        <option value='0' {{ $patient->gender == 0 ? 'selected' : '' }}>Masculino
                                        </option>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select id='update-occupation' class="custom-select" name="occupation">
                                        ...
                                        <option value='2' {{ $patient->occupation == 2 ? 'selected' : '' }}>Estudiante
                                        </option>
                                        <option value='3' {{ $patient->occupation == 3 ? 'selected' : '' }}>Estudiante
                            ...
                            <div class="row">
                                <div
                                    class="form-group{{ $errors->has('phone_number') ? ' has-danger' : '' }} col-md-5 col-auto">
                                ...
                                <div
                                    class="form-group{{ $errors->has('email') ? ' has-danger' : '' }} col-md-5 col-auto">
                                ...
                                {{--  deductible  --}}
                                <div
                                    class="col-md-2 col-auto form-group{{ $errors->has('deductible') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="update-deductible">Deducible</label>
                                    <input type="number" name="deductible" id="update-deductible"
                                        class="form-control form-control-alternative{{ $errors->has('deductible') ? ' is-invalid' : '' }}"
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-5 col-auto">
                                ...
                                <select
                                    ...
                                    <option value="{{ $insurer->id }}"
                                        {{ $patient->insuree->insurer->id == $insurer->id ? 'selected' : '' }}>
                                        {{ $insurer->name }}</option>
                                    @endforeach
                                </select>
                                @if ($errors)
                            ...
                            <div class="form-group col-md-3 col-auto">
                                <label for="input-group_number" class="col-auto col-form-label">Número de grupo</label>
                                <input type="text" name="group_number" id="update-group_number"
                                    class="form-control form-control-alternative{{ $errors->has('group_number') ? ' is-invalid' : '' }}"
                                    placeholder="Número de grupo" value="{{ $patient->insuree->group_number }}">
                                @if ($errors)
                                <span class="invalid-feedback" role="alert">
            ...
            <div class="form-row">
                ...
                <div class="col-lg-4">
                    ...
                    <select id='update-relationship' class="custom-select" name="relationship">
                        <option value='2' {{ $patient->dependent->relationship == 2 ? 'selected' : '' }}>Esposo(a)
                        </option>
                        <option value='1' {{ $patient->dependent->relationship == 1 ? 'selected' : '' }}>Hijo(a)
                        </option>
