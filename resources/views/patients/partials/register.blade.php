            ...
            <div class="pl-lg-4">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 form-group{{ $errors->has('last_name') ? ' has-danger' : '' }}">
                        ...
                        <input type="text" name="last_name" id="input-last_name" class="form-control form-control-alternative{{ $errors->has('last_name') ? ' is-invalid' : '' }}" placeholder="Nombre" value="{{ old('last_name') }}" required autofocus>
                ...
                <div class="row">
                    ...
                    <div class="form-group{{ $errors->has('street_number') ? ' has-danger' : '' }} col-md-8 col-auto">
