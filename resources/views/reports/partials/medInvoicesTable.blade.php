<div class="table-responsive">
    <table class="table align-items-center table-flush table-sm table-hover">
        ...
        <tfoot>
            <tr>
                <td colspan="5" class="text-right">Cargos:  <span class="MXN"> {{ $invoices_totals->getTotalM() }} </span> <span class="USD" style="display: none"> {{ $invoices_totals->getTotal_with_discounts() }}</span></td>
                <td>Abonos: <span class="MXN"> {{ $invoices_totals->amountPaidMXN() }} </span> <span class="USD" style="display: none"> {{ $invoices_totals->getAmountPaid() }}</span></td>
                <td>Saldo:  <span class="MXN"> {{ $invoices_totals->amountDueMXN() }} </span> <span class="USD" style="display: none"> {{ $invoices_totals->getAmountDue() }}</span></td>
            </tr>
        </tfoot>
    </table>
