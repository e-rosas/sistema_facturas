            ...
            <div class="col-xl-4 col-lg-6">
                <div class="card card-stats mb-4 mb-xl-0">
                    <div class="card-body">        
                        <div class="row">
                            <div class="col">
                                <h5 class="card-title text-uppercase text-muted mb-0">{{ __('Invoices') }}</h5>
                                <span class="h2 font-weight-bold mb-0">{{ $service->invoices->Count()  }}</span>
                            </div>
                            <div class="col-auto">
        ...
        <div class="row mt-5">
            <div class="col-xl-12">
                <div class="card shadow">
                    ...
                    @include('services.partials.invoicesTable', ['invoices' => $service->invoices()->paginate(10)])
