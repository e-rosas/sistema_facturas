                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('invoices.store') }}" autocomplete="off">
                            ...
                            <div class="form-row">
                                ...
                                {{-- total --}}
                                <div
                                    class="col-md-4 col-auto form-group{{ $errors->has('total') ? ' has-danger' : '' }}">
            ...
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="col-md-12">
                                <label class="form-control-label" for="input-diagnosis_codes">Procedimientos (Código{Fecha,
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row" id="hospitalization-anesthesia">
                            <div class="col-lg-6 col-auto form-group">
                                <label class="form-control-label" for="hospitalization-minutes">Anestesia (Hora inicial -
                                    Hora final)</label>
    ...
    <script>
        ...
        class Service {
            ...
            totalItemsCart() {
                ...
                this.sub_total_discounted = hospitalization ? this.base_discounted_price : this.base_discounted_price *
                    this.quantity;
        ...
        function addDentalServiceToCartFromInvoice(service_id, description, price, discounted_price,
            quantity, id, DOS, items, descripcion, code, pointers, DOS_to, oral_cavity, tooth_numbers, tooth_surfaces,
            tooth_system, missing) {
                ...
                success: function(response) {
                    for (var i = 0; i < response.length; i++) {
                        addDentalServiceToCartFromInvoice(response[i].service_id, response[i].description,
                            ...
                            response[i].descripcion, response[i].code, response[i].diagnoses_pointers,
                            response[i].DOS_to,
                            response[i].dental.oral_cavity, response[i].dental.tooth_numbers, response[i]
                            .dental.tooth_surfaces, response[i].dental.tooth_system, response[i].dental
                            .missing);
                    }
                    displayCart();
        ...
        function displayCart() {
            ...
            for (var i in this.services) {
                if (this.dental) {
                    optionalRow =
                        '<td><button class="btn btn-icon btn-outline-primary btn-sm" type="button"onClick="showDentalServiceModal(' +
                        this.services[i].id +
                        ')"><span class="btn-inner--icon"><i class="fas fa-tooth"></i></span></button>';
                } else {
