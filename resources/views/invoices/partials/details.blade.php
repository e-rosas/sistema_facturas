            ...
            <div class="row">
                ...
                @if ($invoice->status != 1)
                    <div class="col-md-2 col-auto">
                        <button id="edit-details" type="button" class="btn btn-sm btn-outline-default"
                            data-toggle="modal" data-target="#modal-details">Editar detalles</i></button>
                        <br />
                    </div>
                @endif
        ...
        <div class="card-body">
            ...
            <div class="nav-wrapper">
                <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-icons-text" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link mb-sm-3 mb-md-0 active" id="tab-general-tab" data-toggle="tab"
                            href="#tab-general" role="tab" aria-controls="tab-general" aria-selected="true"><i
                    ...
                    @if ($invoice->hospitalization)
                        <li class="nav-item">
                            <a class="nav-link mb-sm-3 mb-md-0" id="tab-hospitalization-tab" data-toggle="tab"
                                href="#tab-hospitalization" role="tab" aria-controls="tab-hospitalization"
            ...
            <div class="tab-content" id="invoice-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-3 col-auto form-group">
                                ...
                                <span class="MXN" style="display: none"> {{ $invoice->IVAF() }} </span><span
                                    class="USD">
                            ...
                            <div class="col-md-3 col-auto form-group">
                                ...
                                <span class="MXN" style="display: none"> {{ $invoice->subtotalF() }} </span><span
                                    class="USD">
                            ...
                            <div class="col-md-3 col-auto form-group">
                                ...
                                <span class="MXN" style="display: none"> {{ $invoice->totalF() }} </span><span
                                    class="USD">
                ...
                @endif
                @if ($invoice->hospitalization)
                    <div class="tab-pane fade" id="tab-hospitalization" role="tabpanel"
                        aria-labelledby="tab-hospitalization-tab">
                        <div class="form-row">
                            <div class="col-xl-12">
                                @include('invoices.partials.hospitalizationDetails', ['hospitalization' =>
                                $invoice->hospitalization_details])
                            </div>
                        </div>
                    </div>
                @endif
