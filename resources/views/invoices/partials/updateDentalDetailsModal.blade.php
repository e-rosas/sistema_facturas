                            ...
                            <div class="form-row ">
                                ...
                                <div class="col-lg-4 custom-control custom-checkbox mb-3">
                                    <input type="checkbox" name="input-orthodontics" id="input-orthodontics"
                                        class="custom-control-input" onclick="changeOrthodonticsStatus(this.checked)" {{ $dental->orthodontics ? 'checked' : '' }}>
                                ...
                                <div class="col-lg-4 custom-control custom-checkbox mb-3">
                                    <input type="checkbox" name="input-prosthesis" id="input-prosthesis"
                                        class="custom-control-input" {{ $dental->prosthesis_replacement ? 'checked' : '' }}>
                            ...
                            <div id="orthodontics-details" class="form-row">
                                ...
                                <div class="col-md-6 col-auto form-group">
                                    ...
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input name="placed" id="input-placed" class="form-control form-control-alternative"
                                            type="date" value="{{ $dental->appliance_placed->format('Y-m-d') }}">
                                    </div>
                                </div>
                                {{-- Months remaining --}}
                                <div class="col-md-4 col-auto form-group">
                                    ...
                                    <input type="number" name="months-remaining" id="input-months"
                                        class="form-control form-control-alternative" value="{{ $dental->months_remaining }}" required>
                                </div>
                            </div>
                            <div class="form-row">
                                ...
                                <div class="col-md-6 col-auto form-group">
                                    ...
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input name="prior-placement" id="input-prior-placement"
                                            class="form-control form-control-alternative" type="date" value="{{ $dental->prior_placement->format('Y-m-d') }}">
                                    </div>
                                </div>
                                <div class="col-md-6 col-auto form-group">
                                    ...
                                    <select id="input-treatment" class="custom-select" name="input-treatment">
                                        <option value='3' {{ $dental->treatment_resulting_from == 3 ? 'selected' : '' }}>No Aplica</option>
                                        <option value='0'{{ $dental->treatment_resulting_from == 0 ? 'selected' : '' }}>Lesión / enfermedad ocupacional</option>
                                        <option value='1' {{ $dental->treatment_resulting_from == 1 ? 'selected' : '' }}>Accidente automovilístico</option>
                                        <option value='2' {{ $dental->treatment_resulting_from == 2 ? 'selected' : '' }}>Otro accidente</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-row">
                                ...
                                <div class="col-md-6 col-auto form-group">
                                    ...
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input name="placed" id="input-accident" class="form-control form-control-alternative"
                                            type="date" value="{{ $dental->accident->format('Y-m-d') }}">
                                    </div>
                                </div>
                                {{--  Auto Accident State --}}
                                <div class="col-md-6 col-auto form-group">
                                    ...
                                    <input type="text" name="input-accident-state" id="input-accident-state"
                                        class="form-control form-control-alternative" value="{{ $dental->auto_accident_state }}">
                                </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="input-tooth-numbers" id="input-tooth-numbers"
                                        class="form-control form-control-alternative" value="{{ $dental->tooth_numbers }}">
                                </div>
                            </div>
