...
@section('content')
@include('layouts.headers.header', ['title' => 'Nueva ubicación'])
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('locations.store') }}" autocomplete="off">
                        ...
                        <div class="pl-lg-4">
                            <div class="form-row">
                                <div
                                    class="col-md-12 col-auto form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-name">Nombre</label>
                                    <input type="text" name="name" id="input-name"
                                        class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}"
                                        placeholder="Nombre para identificar la ubicación" value="{{ old('name') }}">
                            ...
                            <div class="form-group{{ $errors->has('first_line') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" name="first_line" id="input-first_line"
                                    ...
                                    placeholder="Hospital Mexico..." value="{{  old('first_line') }}" required>
                            ...
                            <div class="form-group{{ $errors->has('second_line') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" name="second_line" id="input-second_line"
                                    ...
                                    placeholder="Calle, número de calle..." value="{{ old('second_line') }}" required>
                            ...
                            <div class="form-row">
                                <div
                                    class="col-md-12 col-auto form-group{{ $errors->has('third_line') ? ' has-danger' : '' }}">
                            ...
                            <div class="form-group{{ $errors->has('billing_first_line') ? ' has-danger' : '' }}">
                                <label class="form-control-label" for="input-billing_first_line">Billing Línea
                                    1</label>
                                <input type="text" name="billing_first_line" id="input-billing_first_line"
                                    ...
                                    placeholder="Hospital Mexico..." value="{{  old('billing_first_line') }}" required>
                            ...
                            <div class="form-group{{ $errors->has('billing_second_line') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" name="billing_second_line" id="input-billing_second_line"
                                    ...
                                    placeholder="Calle, número de calle..." value="{{ old('billing_second_line') }}"
                                    required>
                            ...
                            <div class="form-row">
                                <div
                                    ...
                                    <label class="form-control-label" for="input-billing_fourth_line">Billing Línea 4
                                        (opcional)</label>
                                    <input type="text" name="billing_fourth_line" id="input-billing_fourth_line"
                                        ...
                                        placeholder="Ciudad, estado, C.P." value="{{ old('billing_fourth_line') }}">
