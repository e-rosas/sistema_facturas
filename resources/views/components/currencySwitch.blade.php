<div class="custom-control custom-radio custom-control-inline">
    <input type="radio" onclick="displayUSD(0)"  id="customRadioInlineMXN" checked value="MXN" name="currency" class="custom-control-input">
    <label class="custom-control-label" for="customRadioInlineMXN">MXN</label>
</div>
<div class="custom-control custom-radio custom-control-inline">
    <input type="radio" onclick="displayUSD(1)" id="customRadioInlineUSD" value="USD" name="currency" class="custom-control-input">
