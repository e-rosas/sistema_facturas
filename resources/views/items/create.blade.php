                        ...
                        <form method="post" action="{{ route('items.store') }}"  autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-row">
                                    ...
                                    {{--  price  --}}
                                    <div
                                        class="col-md-4 col-auto form-group{{ $errors->has('price') ? ' has-danger' : '' }}">
                                        <label class="form-control-label" for="input-price">Precio</label>
                                        <input type="numeric" name="price" id="input-price"
                                    ...
                                    {{--  Discount  --}}
                                    <div
                                        class="col-md-4 col-auto form-group{{ $errors->has('discounted_price') ? ' has-danger' : '' }}">
                                        <label class="form-control-label" for="input-discounted_price">Precio con
                                            descuento</label>
                                        <input type="numeric" name="discounted_price" id="input-discounted_price"
                                            class="form-control form-control-alternative{{ $errors->has('discounted_price') ? ' is-invalid' : '' }}"
                                            placeholder="Precio con descuento" value="{{ old('discounted_price') }}"
                                            required>
                                ...
                                <div class="form-row">
                                    {{--  Category  --}}
                                    <div class="form-group col-auto col-md-12">
